...
======================================================= */
const ADMIN_PASSWORD = "cpg-2025"; // <-- cámbiala
...
function closeModal(){ adminModal.setAttribute('aria-hidden','true'); adminPass.value=''; adminBody.hidden=true; adminAuth.hidden=false; }
